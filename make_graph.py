# derived from  https://github.com/szagoruyko/pytorchviz/blob/master/torchviz/dot.py
...
def make_dot(fname, var, params=None):# by Chao
    ...
    resize_graph(dot)
    dot.save(fname) # by Chao.
    filename, ext = splitext(fname)
    check_call(['dot','-Tpng', fname, '-o', filename+'.png'])
    #  return dot # by Chao.
